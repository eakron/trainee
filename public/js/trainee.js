...
var test_questions = [
{
    "id": 0,
    "source" : "certexam",
    "question": "QUESTION 2. You are managing a SharePoint farm in an Active Directory Domain Services (AD D5) domain.  You need to configure a service account to use domain credentials. What should you do first?",
    "answer": ["D"],
...
},
{
    "id": 0,
    "source" : "certexam",
    "question": "QUESTION 9  A company uses SharePoint 2013 Server as its intranet portal. The Marketing department publishes many news articles, press releases, and corporate communications to the intranet home page. You need to ensure that the Marketing department pages do not impact intranet performance. Which two actions should you perform? (Each correct answer presents part of the solution.Choose two.)",
    "answer": ["A","D"],
...

{
    "id": 0,
    "source" : "certexam",
    "question": "Question 10. You are managing a SharePoint farm. Diagnostic logs are rapidly consuming disk space. You need to minimize the amount of log data written to the disk. Which two actions should you perform? (Each correct answer presents part of the solution. Choose two.)",
    "answer": ["C","D"],
...

{
    "id": 0,
    "source" : "certexam",
    "question": "QUESTION 57  You are managing SharePoint Online site collections. You need to assign the minimum permission level necessary to create subsites. Which permission level should you assign?",
    "answer": ["C"],
    "a": "A. Approve",
    "b": "B. Design",
...

{
    "id": 0,
    "source" : "certexam",
    "question": "QUESTION 59  A SharePoint farm includes two front-end web servers, one application server, and two clustered servers  that run Microsoft SQL Server. The SharePoint Foundation Web Application service is not running on the application server. You plan to configure the SharePoint farm to receive and store email messages and email message attachments in libraries. You need to ensure that users can send email messages and attachments directly to libraries across the entire farm. You must accomplish this goal by using the least amount of effort. Which two actions should you perform?  (Each correct answer presents part of the solution. Choose two.)",
    "answer": ["B,D"],
...

{
    "id": 0,
    "source" : "certexam",
    "question": "QUESTION 61  You are managing a site collection in a SharePoint farm. You need to configure the minimum level of permissions necessary for users to manage lists in the site collection. What permission level should you configure?",
    "answer": ["D"],
    "a": "A. Contribute",
    "b": "B. Read",
    "c": "C. Full Control",
...

{
    "id": 0,
    "source" : "certexam",
    "question": "QUESTION 63  You are managing a SharePoint farm. You need to enable friendly URLs for a term set. What should you configure?",
    "answer": ["B"],
...

{
    "id": 0,
    "source" : "certexam",
    "question": "QUESTION 65  You are managing a SharePoint farm. The SharePoint databases are configured to run on a dedicated  instance of Microsoft SQL Server 2008 R2 Service Pack 1. You need to optimize query executions. What should you do?",
    "answer": ["D"],
    "a": "A. Move the master database to a RAID 10 volume.",
...

{
    "id": 0,
    "source" : "certexam",
    "question": "QUESTION 66  You are managing a site collection in a SharePoint farm. You need to configure the minimum level of permissions necessary for users to manage lists in the site collection. What permission level should you configure?",
    "answer": ["C"],
    "a": "A. Limited Access",
    "b": "B. View Only",
    "c": "C. Edit",
...

{
    "id": 0,
    "source" : "certexam",
    "question": "QUESTION 68  You are the farm administrator for a single-server SharePoint 2010 Foundation environment. The company plans to upgrade to SharePoint 2013 Foundation. You need to ensure that the existing server meets the minimum requirements. Which three requirements must you meet? (Each correct answer presents part of the solution. Choose three.)",
    "answer": ["B,C,D"],
...

{
    "id": 0,
    "source" : "certexam",
    "question": "QUESTION 69  You are managing a site collection in a SharePoint farm.  You need to configure the minimum level of permissions necessary for users to manage lists in the site collection. What permission level should you configure?",
    "answer": ["A"],
    "a": "A. Edit",
    "b": "B. Contribute",
    "c": "C. Read",
...
},
{
    "id": 0,
    "source" : "certexam",
    "question": "QUESTION 24A company is planning to upgrade from SharePoint 2010 to SharePoint 2013.You need to find out the web traffic capacity of the SharePoint farm by using a Microsoft Visual StudioTeam System project file.Which tool should you use?",
    "answer": ["D"],
    "a": "A. Network Monitor",
...
},
{
    "id": 0,
    "source" : "certexam",
    "question": " QUESTION 26A web application is configured in a SharePoint environment.A user receives an application error message that includes a correlation ID.You need to find out the cause of the error.Which two actions can you perform to achieve this goal? (Each correct answer presents a completesolution. Choose two.)",
    "answer": ["A","B"],
...
},
{
    "id": 0,
    "source" : "certexam",
    "question": " QUESTION 28A company has a SharePoint environment that consists of two web applications. The first web application isused as the corporate intranet site, and the second web application hosts several custom apps. The customapps use Microsoft Business Connectivity Services (BCS) Web Parts to retrieve data from externalsystems.The home page of the second web application displays information from three custom apps and rendersslowly.You need to identify the custom app that is causing the slow response times.Which tool should you use?",
    "answer": ["A"],
...
},
{
    "id": 0,
    "source" : "certexam",
    "question": " QUESTION 30You are managing a site collection in a SharePoint farm.You need to configure the minimum level of permissions necessary for users to manage lists in the sitecollection.What permission level should you configure?",
    "answer": ["C"],
    "a": "A. Full Control",
    "b": "B. Create",
    "c": "C. Design",
...
},
{
    "id": 0,
    "source" : "certexam",
    "question": " QUESTION 33You are managing a SharePoint farm.You need to collect information about the health of a web application.What should you use?",
    "answer": ["D"],
...

{
    "id": 0,
    "source" : "certexam",
    "question": " QUESTION 59 A SharePoint farm includes two front-end web servers, one application server, and two clustered serversthat run Microsoft SQL Server. The SharePoint Foundation Web Application service is not running on theapplication server.You plan to configure the SharePoint farm to receive and store email messages and email messageattachments in libraries.You need to ensure that users can send email messages and attachments directly to libraries across theentire farm. You must accomplish this goal by using the least amount of effort.Which two actions should you perform? (Each correct answer presents part of the solution.Choose two.)",
    "answer": ["B","D"],
    "a": "A. Install and configure the Simple Mail Transfer Protocol (SMTP) service on each application server.",
    "b": "B. Install and configure the Simple Mail Transfer Protocol (SMTP) service on each front-end web server.",
    "c": "C. Enable incoming email by using the Automatic settings mode.",
...
},
{
    "id": 0,
    "source" : "certexam",
    "question": " QUESTION 61You are managing a site collection in a SharePoint farm.You need to configure the minimum level of permissions necessary for users to manage lists in the sitecollection.What permission level should you configure?",
    "answer": ["D"],
    "a": "A. Contribute",
    "b": "B. Read",
    "c": "C. Full Control",
...
},
{
    "id": 0,
    "source" : "certexam",
    "question": " QUESTION 63You are managing a SharePoint farm.You need to enable friendly URLs for a term set.What should you configure?",
    "answer": ["B"],
    "a": "A. Term set tagging",
    "b": "B. Managed navigation",
    "c": "C. Custom properties",
...
},
{
    "id": 0,
    "source" : "certexam",
    "question": " QUESTION 68You are the farm administrator for a single-server SharePoint 2010 Foundation environment.The company plans to upgrade to SharePoint 2013 Foundation.You need to ensure that the existing server meets the minimum requirements.Which three requirements must you meet? (Each correct answer presents part of the solution.Choose three.)",
    "answer": ["B","C","D"],
    "a": "A. 64-bit edition of Windows Server 2008 SP2",
    "b": "B. 64-bit processor",
    "c": "C. 8 GB of RAM",
...
},
{
    ...
    "d_answer": ""
        ...
        "id": 0,
        "source" : "certexam",
        "question": "You are the term store manager of a SharePoint environment. You need to make term sets available across the entire farm. You must ensure that users can reuse terms but not edit terms. Which two actions should you perform? (Each correct answer presents part of the solution. Choose two.) ",
        "answer": ["A","B"],
    ...
    },
    {
        "id": 0,
        "source" : "certexam",
        "question": "A company is planning to deploy My Sites to its 25,000 employees. The company will maintain dedicated content databases for the storage of personal site collections. You need to create the minimum number of content databases required to support the My Sites. What should you do? ",
        "answer": ["D"],
    ...
    },
    {
        "id": 0,
        "source": "certexam",
        "question": "You are managing a SharePoint farm. The SharePoint databases are configured to run on a dedicated instance of Microsoft SQL Server 2008 R2 Service Pack 1. You need to optimize query executions.What should you do?",
        "answer": ["C"],
        ...
        "explanation": "Explanation: The read performance will double with a RAID 10 volume.Incorrect:not A, not D: The master database records all the system-level information for a SQL Server system. Thisincludes instance-wide metadata such as logon accounts, endpoints, linked servers, and systemconfiguration settings.Not C: This is already the default settings.* By default, the Max Degree Of Parallelism setting has a value of 0, which means that the maximumnumber of processors used for parallel processing is controlled automatically. Essentially, SQL Server usesthe actual number of available processors, depending on the workload. To limit the number of processorsused for parallel processing to a set amount (up to the maximum supported by SQL Server), change theMax Degree Of Parallelism setting to a value greater than 1. A value of 1 tells SQL Server not to useparallel processing."
    },
    {
        "id": 0,
        "source": "certexam",
